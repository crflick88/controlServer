...
var FacturaRecibidaSchema = new Schema({
    ...
    productos:{type:[{ //arreglo de productos que contienen info del producto y cantidad que entra
        ...
        precio: {type: Number, required: true} //precio en el que fue comprado el producto, puede ser diferente al precio en coleccion producto
    }], required: true},    
    monto: {type: Number, required: true} // monto total de venta ya con iva
});

// pass Schema using module.exports
module.exports = mongoose.model('FacturaRecibida',FacturaRecibidaSchema);